//CARRINHOOOOOOOOOOOOOOOOOOOOO
function apagarProduto() {
    // Remove a box da tela
    ...
    // Vai para outra página após 2 segundos
    setTimeout(() => {
        window.location.href = "/COMPRAS/compras1.html"; // Altere para a página desejada
    }, 2000);
}
